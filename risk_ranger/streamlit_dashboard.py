...
def upload_photo():
    ...
    #     f.write(uploaded_photo.getbuffer())
    # cur.execute("INSERT INTO accident_photos (report_id, photo_path) VALUES (%s, %s)", (flt_number, photo_path))
...
def main():
    ...
    page = st.sidebar.radio(
        "Go to",
        ["Home", "Accident Report Form", "Driver Lookup", "Vehicle Lookup", "Tutorial", "FLT Lookup", "Admin", "Upload Photos"],
    )
    if page == "Home":
